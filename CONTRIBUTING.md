# Contributing to QueryLedger

English and French contributions are welcome.

## Source of truth

The [GitLab origin](https://gitlab.elielaloum.com/elielaloum/queryledger) is private. The [GitHub mirror](https://github.com/elie-laloum/queryledger) provides public access to the source and documentation.
